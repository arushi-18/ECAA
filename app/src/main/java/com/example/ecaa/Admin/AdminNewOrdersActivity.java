...
import com.example.ecaa.Model.AdminOrders;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminOrders,AdminOrdersViewHolder> adapter=
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull AdminOrders adminOrders)
                    {
                        final AdminOrders model=adminOrders; //to be checked
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                builder.setTitle("have you shipped these order products?");
